...
const ServiceDetails = () => {
  ...
  const cleanDescription = DOMPurify.sanitize(portfolioService?.description || '', {
  ...
  return (
    <div className="font-sans bg-white p-4">
      <div className="grid items-start grid-cols-1 lg:grid-cols-4 gap-x-12 max-w-6xl mx-auto">
        ...
        {/* Details Section */}
        <div className="lg:col-span-2 flex flex-col justify-center">
          <h2 className="mt-4 sm:mt-0 text-3xl font-semibold text-black">{portfolioService?.name}</h2>
          ...
          <div className="flex items-center p-4 rounded-lg shadow-sm mt-4">
            ...
            <div className="flex flex-col space-y-3">
              <h2 className="text-xl font-bold text-black">{portfolioService?.agencyName}</h2>
        ...
        <div className="mt-8 lg:col-span-4">
          <h3 className="text-xl font-semibold text-black">About this service</h3>
