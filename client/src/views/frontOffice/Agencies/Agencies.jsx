...
export const Agencies = () => {
  const { agencies, totalPages, currentPage, nextPage, previousPag, totalCount
  } = useSelector((state) => state.agencies.agencies);
  const pages = useSelector((state) => state.agencies.agencies);
          ...
          <div className="container px-5 py-24 mx-auto">
            ...
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {agencies &&
                  agencies.map((serv) => (
                    <div key={serv?._id} className="bg-white p-8 rounded-lg shadow-md relative">
