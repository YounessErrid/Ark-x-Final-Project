        ...
        <div className="container grid grid-cols-12 gap-6">
          ...
          <div className="border-n30 col-span-12 rounded-xl border px-6 py-8 lg:col-span-4">
            ...
            <div className="relative">
              <img
                src={mariagePhoto} // Replace with the URL of the cover photo
                alt="Cover Photo"
          ...
          {/* Services */}
          <div className="border-n30 col-span-12 rounded-xl border p-4 sm:p-8 lg:col-span-8 overflow-hidden">
            ...
            <div className="flex flex-col gap-4 pt-6 overflow-y-auto h-full">
