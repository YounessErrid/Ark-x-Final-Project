      ...
      {isOpen && (
        <div className="absolute right-0 w-40 mt-2 py-2 bg-white border rounded shadow-xl">
          <Link
            to={
              user.role === "agency"
                ? `/agency/profile/${user?.agencyId}`
                : `/client/profile/update-user`
            }
          >
            <button className="w-full text-left transition-colors duration-200 block px-4 py-2 text-normal text-gray-900 rounded hover:bg-blue-200 hover:text-white" onClick={toggleDropdown}>
              Profile
            </button>
          </Link>
          <div className="py-2">
          ...
          <Link>
            <button
              className="w-full text-left transition-colors duration-200 block px-4 py-2 text-normal text-gray-900 rounded hover:bg-blue-200 hover:text-white"
