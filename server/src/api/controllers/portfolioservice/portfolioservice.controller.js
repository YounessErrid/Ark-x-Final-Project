const portfolioservice = require('../models/portfolioervice.model');
...
const create = async (req , res) => {
    ...
    try{
        ...
        const newPortfolioService = new portfolioservice({name, description, image, portfolioId, serviceId});
...
const update = async (req , res) => {
    try{
        ...
        const updatedPortfolioService = await portfolioservice.findByIdAndUpdate(id, {name, description, image, portfolioId, serviceId});
...
const remove = async (req , res) => {
    try{
        const {id} = req.params;
        const deletedPortfolioService = await portfolioservice.findByIdAndDelete(id);
