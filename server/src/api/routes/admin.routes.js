...
const { isSuperAdmin, authMiddleware } = require("../middlewares/roles");
...
router.post(
  "/createAdmin",
  [validateRegisterAdmin, isAuthenticated ,authMiddleware("superadmin")],
...
router.delete("/:id", isAuthenticated,authMiddleware("superadmin"), controller.remove);
